...
export function OutputFileNode({ id, data }: { id: string; data: any }) {
  ...
  return (
    <div className="px-4 py-2 shadow-md rounded-md min-w-[150px]" style={style}>
      <Handle type="target" position={Position.Left} className="w-3 h-3 bg-[var(--accent-success)] border-2 border-[var(--bg-base)]" />
      <div className="flex items-center gap-2 mb-2">
        <div className="p-1.5 rounded text-[var(--accent-success)]" style={{ background: 'color-mix(in srgb, var(--accent-success) 25%, transparent)' }}>
