...
> **Important:** The application refuses to start in every environment if `SECRET_KEY` is missing, shorter than 32 characters, or set to a known default. Always set a strong, unique key.
