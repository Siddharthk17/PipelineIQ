...
5. [Data Model — All 14 Entities](#5-data-model--all-14-entities)
...
## 5. Data Model — All 14 Entities

All entities are defined in `backend/models.py` (348 lines). No model is defined
